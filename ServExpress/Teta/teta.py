...
def editJSON (source,content):
    result = False
    data_source = json.loads(handFiles.read(source))
...
while(on == 1):
    ...
    if response_1 == 'h' or response_1 == 'help' or response_1 == 'np' or response_1 == 'x' or response_1 == 'exit':
                ...
                if response_np == 'y' or response_np == 'yes':
                    ...
                    while(bcl_vald_np == 1):
                        ...
                        if validation_np == 'yes' or validation_np == 'y':
                            ...
                            editJSON('ServExpress/urls.json',{"name":nom_page,"liens":nom_liens,"Views":nom_views,"Controller":nom_controller,"css":nom_css})
                    ...
                    while(bcl_pg == 1):
                        if nom_page != '':
                            ...
                            if validation_np == 'yes' or validation_np == 'y':
                                ...
                                editJSON('ServExpress/urls.json',{"name":nom_page,"liens":[nom_page],"Views":nom_page,"Controller":nom_page,"css":nom_page})
                    ...
                    print("Wrong entry")
        if response_1 == 'x' or response_1 == 'exit':
            on = 0
    else:
