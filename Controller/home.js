...
exports.Controller = async function Controller(data) {
    ...
    if (data == undefined || data == "no_data") {
        /**
         ...
         */
        fonctionController.use_redirect = true;
         ...
         */
        fonctionController.url_Redirect = "/test1";
        /**
         ...
         */
            ...
            let info;
            let nom;
            if (typeof data.openthedoor == 'string') {
                nom = "openthedoor";
                info = data.openthedoor
            } else {
